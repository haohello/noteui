...
export type ResponsiveArrayValue<T> = Array<T | null>;

export type ResponsiveObjectValue<T> = { [key: string]: T };
...
/* {
  [P in keyof CSS.Properties]: ResponsiveValue<TLengthStyledSystem>;
} */

// export type SxType = ReturnType<typeof createStyleFunction>
export type ParserConfig = {[K: string]: ConfigStyleEx}