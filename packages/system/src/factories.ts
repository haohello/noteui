...
import { mergeStyles } from './themes/mergeThemes'
...
function createShorthandFromValue<P>({
  ...
  // Merge props
  const props: ObjectOf<any> = { ...defaultProps, ...usersProps, ...overrideProps }

  const mappedHTMLProps: ShorthandProp | undefined = mappedProps[overrideProps.as || defaultProps.as]
